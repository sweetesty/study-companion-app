...
export default function FocusScreen() {
  ...
  const totalSeconds = (isWork ? WORK_MINUTES : BREAK_MINUTES) * 60;
  ...
  }, [isWork, stop, addFocusSession, showToast]);
  ...
  const reset = () => {
    stop();
    setTimeLeft((isWork ? WORK_MINUTES : BREAK_MINUTES) * 60);
  };
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.controls}>
          ...
          <TouchableOpacity
            ...
            onPress={() => { stop(); setIsWork(!isWork); setTimeLeft((!isWork ? WORK_MINUTES : BREAK_MINUTES) * 60); }}
          >
